...
1. [Fork it](https://github.com/jolicode/harvest-openapi-generator/fork_select)
2. improve it
...
```shell
git remote add upstream https://github.com/jolicode/harvest-openapi-generator.git
```
